Great set of problems 🚀. I’ll provide **Java solutions** for each problem in both **brute force** and **optimized approaches**, with **inline comments**, **time and space complexity**, and **2 sample test cases** each.

---

# ✅ 1. Return element from a Pascal Triangle
...
public class PascalTriangleElement {
    ...
    // Optimized: Use nCr formula directly → n! / (r! * (n-r)!)
...
# ✅ 2. Reverse String and Fix Errors
...
# ✅ 7. Top 10 Videos with Highest Watch Rates
...
public class TopVideos {
    ...
    // Time: O(n log 10) ≈ O(n), Space: O(10)
...
👉 Do you want me to **combine all problems into a single `Main.java` file** with each problem as a separate method/class (for easier testing), or keep them as **separate standalone programs** like above?
